...
public class ExcelParser {
    ...
    public static void main(String[] args) {
        String path1 = "C:\\Users\\ericj\\Desktop\\人员信息.xlsx";
        String path2 = "C:\\Users\\ericj\\Desktop\\人员信息示例.xlsx";
        String path3 = "C:\\Users\\ericj\\Desktop\\人员信息示例3.xlsx";
        System.out.println("path1内容");
        getExcelContent(path1);
        System.out.println();
        System.out.println("path2内容");
        getExcelContent(path2);
        System.out.println();
        System.out.println("path3内容");
        getExcelContent(path3);
    }
